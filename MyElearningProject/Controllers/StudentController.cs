...
namespace MyElearningProject.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            ViewBag.breadcrumb = "Öğrenci Listesi";
        ...
        {
            ViewBag.breadcrumb = "Öğrenci Listesi - Öğrenci Ekleme Sayfası";
            return View();
        }
        ...
        {
            ViewBag.breadcrumb = "Öğrenci Listesi - Öğrenci Güncelleme Sayfası";
            var value = context.Students.Find(id);
            return View(value);
        }
